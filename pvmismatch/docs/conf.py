...
latex_documents = [
  ('index', '%s.tex' % __name__, '%s Documentation' % __name__,
   '%s' % __author__, 'manual'),
]
...
man_pages = [
    ('index', '%s' % __name__, '%s Documentation' % __name__,
     ['%s' % __author__], 1)
]
...
texinfo_documents = [
  ('index', '%s' % __name__, '%s Documentation' % __name__,
   '%s' % __author__, '%s' % __name__, 'One line description of project.',
   'Miscellaneous'),
]
